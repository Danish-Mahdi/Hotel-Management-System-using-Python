...
class HotelManagementSystem:
        ...
        # title
                ...
                lbl_title.place(x=0,y=80,width=1550,height=50)
        # main frame
        ...
        # btn frame
                ...
                cust_btn=Button(btn_frame,text='CUSTOMER',command=self.cust_details ,width=22,font=('times new roman', 14,'bold'),bg='black',fg='gold', bd=4,relief=RIDGE,cursor='hand1')
                cust_btn.grid(row=0,column=0,pady=1)

                room_btn=Button(btn_frame,text='ROOM',command=self.roombooking,width=22,font=('times new roman', 14,'bold'),bg='black',fg='gold', bd=4,relief=RIDGE,cursor='hand1')
                room_btn.grid(row=1,column=0,pady=1)

                details_btn=Button(btn_frame,text='DETAILS',command= self.DetailsRoom ,width=22,font=('times new roman', 14,'bold'),bg='black',fg='gold', bd=4,relief=RIDGE,cursor='hand1')
                ...
                logout_btn=Button(btn_frame,text='LOGOUT',width=22,font=('times new roman', 14,'bold'),bg='black',fg='gold', bd=4,relief=RIDGE,cursor='hand1')
